import { Typography, Box, Stack, Paper, Grid, styled } from "@mui/material";
    ...
    <Box sx={{ my: 2, mx: { lg: 0, xs: 1 } }}>
      <Stack
        ...
        sx={{
          pb: 2,
          px: { lg: 0, xs: 1 },
          width: { lg: "100%", md: "100%", sm: "100%", xs: "100vw" },
          overflow: "auto",
          flexDirection: "row",
          flexWrap: "no-wrap",
        }}
      >
        <Paper
          elevation={3}
          sx={{
            minWidth: { lg: "280px", md: "200px", sm: "200px", xs: "200px" },
            maxWidth: { lg: "280px", md: "200px", sm: "200px", xs: "200px" },
            height: { lg: "150px" },
            borderRadius: "15px",
        ...
        >
          ...
          >
            &quot; EIA Notification_Dated 20.07.2022_Cold Rolled <br /> Stainless
