              ...
              >
                ...
                >
                  <Link
                    ...
                    sx={{
                      color: isActive(
                        menuItem.href.substring(1, menuItem.href.length - 1)
                      )
                        ? "primary.main"
                        : "#000",
                      textDecoration: "none",
                    ...
                    (mobileView ? (
                      toggle[menuItem.name] ? (
                        <ExpandLess
                          ...
                          sx={{
                            ml: 1,
                            color: open[menuItem.name] ? "primary.main" : "",
                          }}
                        />
                      ) : (
                        <ExpandMore
                                      ...
                                      >
                                        <Link
                                          ...
                                          sx={{
                                            ...
                                            justifyContent: "space-between",
                                            color: isActive(
                                              nestedSubItem.href.substring(
                                                1,
                                                nestedSubItem.href.length - 1
                                              )
                                            )
                                              ? "primary.main"
                                              : "#000",
                            ...
                            <div key={subItem.name} style={{ width: "100%" }}>
                              ...
                              {subItem?.subItems && (
                                <Collapse
                                  ...
                                  onMouseLeave={() =>
                                    handleClickLeave(menuItem.name)
                                  }
                                >
                                  <List component="div" disablePadding>
                                    {subItem?.subItems?.map((nestedSubItem) => (
                                      ...
                                      >
                                        <Link
                                          ...
                                          sx={{
                                            ...
                                            display: "flex",
                                            justifyContent: "space-between",
                                            color: isActive(nestedSubItem.href)
                                              ? "primary.main"
                                              : "#000",
                                            "&:hover": {
                                              color: "primary.dark",
